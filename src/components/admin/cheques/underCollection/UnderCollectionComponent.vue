<template>
    <div class="container pe-5 ps-5">
        <!-- العنوان -->
        <h1><i class="bi bi-bank2 me-2"></i> {{ $t('label.under_collection') }}</h1>
    ...
    data() {
        return {
            ...
            checks: [
                {
                    id: 1,
                    check_number: 'UC-1001',
                    check_date: '2025-01-12',
                    right_date: '2025-01-15',
                    check_owner: 'شركة السلام',
                ...
                {
                    id: 2,
                    check_number: 'UC-1002',
                    check_date: '2025-02-05',
                    right_date: '2025-02-10',
                    check_owner: 'مؤسسة الريادة',
