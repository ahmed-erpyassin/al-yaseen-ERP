<template>
    <div class="container pe-5 ps-5">
        <!-- العنوان -->
        <h1><i class="bi bi-arrow-left-right me-2"></i> {{ $t('label.incoming_outgoing') }}</h1>
...
export default {
    name: 'IncomingOutgoingComponent',
    data() {
        return {
            searchQuery: '',
            currentPage: 1,
            ...
            checks: [
                {
                    id: 1,
                    check_number: 'IO-1001',
                    check_date: '2025-01-10',
                    right_date: '2025-01-15',
                    check_owner: 'شركة الأمل',
                    account_number: 'ACC-123',
                    account_name: 'شركة الأمل التجارية',
                    statement: 'تحويل بين حسابات',
                    bank_name: 'بنك فلسطين',
                    bank_account: 'BNK-111',
                    branch_name: 'غزة الرئيسي',
                    transaction_date: '2025-01-12',
                    voucher_account_number: 'VCH-2021',
                    amount: '2500',
                    currency: 'ILS'
                },
                {
                    id: 2,
                    check_number: 'IO-1002',
                    check_date: '2025-02-05',
                    right_date: '2025-02-10',
                    check_owner: 'شركة الريادة',
                    account_number: 'ACC-789',
                    account_name: 'الريادة للاستثمار',
                    statement: 'شيك صادر',
                    bank_name: 'البنك الإسلامي',
                    bank_account: 'BNK-222',
                    branch_name: 'فرع الرمال',
                    transaction_date: '2025-02-06',
                    voucher_account_number: 'VCH-2022',
                    amount: '4800',
                    currency: 'USD'
                }
            ],
            table: {
                fields: [
                    ...
                    { name: 'صاحب الشيك', key: 'check_owner', status: true },
        ...
        viewCheck(check) {
            Swal.fire({
                ...
                html: `
                    ...
                    <p><b>صاحب الشيك:</b> ${check.check_owner}</p>
