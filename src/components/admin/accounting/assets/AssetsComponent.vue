<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="d-flex align-items-center justify-content-end">
            <router-link :to="{ name: 'admin.accounting.assets.create' }" class="btn btn-lg btn-main me-3">{{
                $t('buttons.create')
            }}</router-link>
...
export default {
    ...
    data() {
        ...
        return {
            table: {
                fields: [
                    { name: this.$t('label.asset_number'), status: true },
                    { name: this.$t('label.asset_details'), status: true },
                    { name: this.$t('label.purchase_price'), status: true },
                    { name: this.$t('label.asset_statement'), status: true },
                    { name: this.$t('label.purchase_date'), status: true },
                    { name: this.$t('label.account'), status: true },
                    { name: this.$t('label.depreciation_summary_account'), status: true },
                    { name: this.$t('label.department'), status: true },
                    { name: this.$t('label.employee'), status: false },
                    { name: this.$t('label.department_name'), status: false },
                    { name: this.$t('label.branch'), status: false }
                ]
