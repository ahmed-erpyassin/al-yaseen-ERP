<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('label.departments') }}</h3>
            </div>
        </div>
        <div class="d-flex align-items-center actions mb-3">
            <div class='search me-2 mb-3'>
                <i class="bi bi-search me-2"></i>
                <span class="text-main">{{ $t('label.search_department') }}</span>
            </div>
        ...
        return {
            table: {
                fields: [
                    ...
                    {
                        name: this.$t('label.estimated_balance'),
                        status: true
                    },
                    {
                        name: this.$t('label.manager'),
                        status: true
                    },
                    {
                        name: this.$t('label.project_start_date'),
                        status: true
                    },
                    {
                        name: this.$t('label.project_end_date'),
                        status: true
                    }
                ]
