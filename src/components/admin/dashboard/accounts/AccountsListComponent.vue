<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="d-flex align-items-center justify-content-end">
            <router-link :to="{ name: 'admin.new-account' }" class="btn btn-lg btn-main me-3">{{ $t('buttons.create')
                }}</router-link>
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('aside.chart_of_accounts') }}</h3>
            </div>
        </div>
        ...
        return {
            table: {
                fields: [
                    ...
                    {
                        name: this.$t('label.balance_currency'),
                        status: true
                    },
                    {
                        name: this.$t('label.level'),
                        status: true
                    },
                    {
                    ...
                    {
                        name: this.$t('label.classification'),
                        status: true
                    },
                    {
                    ...
                    {
                        name: this.$t('label.nature'),
                        status: true
                    },
                    {
                        name: this.$t('label.account_opened'),
                        status: true
                    },
                    {
                        name: this.$t('label.related_account'),
                        status: true
                    },
                    {
