<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="d-flex align-items-center justify-content-end">
            <router-link :to="{ name: 'admin.banks.create' }" class="btn btn-lg btn-main me-3">{{ $t('buttons.create')
                }}</router-link>
        ...
        <div class="d-flex align-items-center actions mb-3">
            <div class='search me-2 mb-3'>
                ...
                <span class="text-main">{{ $t('label.search_bank') }}</span>
            </div>
        ...
        <div class="d-flex align-items-center justify-content-end">
            <div class="pages">
                <p class="text-main mb-0">{{ $t('label.bank_statement') }}</p>
            </div>
        </div>
        ...
        return {
            table: {
                fields: [
                    ...
                    {
                        name: this.$t('label.branch_number'),
                        status: true
                    },
                    {
                    ...
                    {
                        name: this.$t('label.phone'),
                        status: true
                    },
                    {
                        name: this.$t('label.fax_number'),
                        status: false
                    },
                    {
