<template>
    <div class="container pe-5 ps-5">
        <!-- العنوان -->
        <h1><i class="bi bi-receipt-cutoff me-2"></i> {{ $t('label.credit_notices') }}</h1>

        <!-- أزرار التحكم -->
        <div class="d-flex align-items-center justify-content-end mb-3">
            <router-link :to="{ name: 'admin.recipts-and-payments.credit-notices.create' }"
        ...
        <div class="table-responsive">
            <table class="table table-bordered text-center align-middle">
                ...
                <tbody>
                    ...
                    <tr v-else v-for="(notice, index) in paginatedItems" :key="index">
...
export default {
    ...
    data() {
        return {
            ...
            perPage: 10,
            items: [
                { notification_number: 'CRN-001', date: '2025-10-08', hour: '09:10', account_no: 'A101', customer_name: 'شركة غزة', licensed_operator: 'Omar', amount: 800, currency: 'USD', registration_number: 'REG-5001' },
                { notification_number: 'CRN-002', date: '2025-10-07', hour: '11:20', account_no: 'A102', customer_name: 'شركة القدس', licensed_operator: 'Lina', amount: 620, currency: 'USD', registration_number: 'REG-5002' },
                { notification_number: 'CRN-003', date: '2025-10-06', hour: '13:00', account_no: 'A103', customer_name: 'شركة رفح', licensed_operator: 'Ali', amount: 950, currency: 'EUR', registration_number: 'REG-5003' }
            ],
            table: {
                fields: [
