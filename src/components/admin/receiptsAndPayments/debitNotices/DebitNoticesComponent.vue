<template>
    <div class="container pe-5 ps-5">
        <!-- العنوان -->
        <h1><i class="bi bi-receipt me-2"></i> {{ $t('label.debit_notices') }}</h1>

        <!-- الأزرار -->
        <div class="d-flex align-items-center justify-content-end mb-3">
            <router-link :to="{ name: 'admin.recipts-and-payments.debit-notices.create' }"
...
export default {
    ...
    data() {
        return {
            ...
            perPage: 10,
            items: [
                { notification_number: 'DBN-001', date: '2025-10-08', hour: '10:45', account_no: 'A001', customer_name: 'شركة غزة', licensed_operator: 'Omar', amount: 1200, registration_number: 'REG-3001' },
                { notification_number: 'DBN-002', date: '2025-10-07', hour: '09:20', account_no: 'A002', customer_name: 'شركة القدس', licensed_operator: 'Hassan', amount: 950, registration_number: 'REG-3002' },
                { notification_number: 'DBN-003', date: '2025-10-06', hour: '11:15', account_no: 'A003', customer_name: 'شركة فلسطين', licensed_operator: 'Lina', amount: 2100, registration_number: 'REG-3003' }
            ],
            table: {
                fields: [
