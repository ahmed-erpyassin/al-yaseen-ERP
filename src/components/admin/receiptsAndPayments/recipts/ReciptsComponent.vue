<template>
    <div class="container pe-5 ps-5">
        <!-- العنوان -->
        <h1><i class="bi bi-receipt-cutoff me-2"></i> {{ $t('label.recipts') }}</h1>

        <!-- أزرار التحكم -->
        <div class="d-flex align-items-center justify-content-end mb-3">
            <router-link :to="{ name: 'admin.recipts-and-payments.recipts.create' }" class="btn btn-lg btn-main me-3">
                {{ $t('buttons.create') }}
            </router-link>
        ...
        <div class="table-responsive">
            <table class="table table-bordered text-center align-middle">
                ...
                <tbody>
                    ...
                    <tr v-else v-for="(receipt, index) in paginatedItems" :key="index">
                        <td v-for="field in visibleFields" :key="field.key">{{ receipt[field.key] }}</td>
...
export default {
    ...
    data() {
        return {
            ...
            perPage: 10,
            items: [
                { number: 'RCP-001', account: '001', account_name: 'Account A', cash: 1500, cheques: '-', currency: 'USD', date: '2025-10-08', registration_number: 'REG-1001', user: 'Admin' },
                { number: 'RCP-002', account: '002', account_name: 'Account B', cash: 800, cheques: 500, currency: 'USD', date: '2025-10-07', registration_number: 'REG-1002', user: 'John' },
                { number: 'RCP-003', account: '003', account_name: 'Account C', cash: '-', cheques: 1200, currency: 'EUR', date: '2025-10-06', registration_number: 'REG-1003', user: 'Sara' }
            ],
            table: {
                fields: [
