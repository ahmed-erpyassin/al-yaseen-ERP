<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('label.payroll_report') }}</h3>
            </div>
        </div>
...
export default {
    ...
    data() {
        ...
        return {
            table: {
                fields: [
                    { name: this.$t('label.report'), status: true },
                    { name: this.$t('label.date'), status: true },
                    { name: this.$t('label.account'), status: true },
                    { name: this.$t('label.salary_for_period'), status: true },
                    { name: this.$t('label.total_salaries'), status: true },
                    { name: this.$t('label.deductions'), status: true },
                    { name: this.$t('label.currency'), status: true },
                    { name: this.$t('label.user'), status: true },
                    { name: this.$t('label.entry'), status: true },
                ]
