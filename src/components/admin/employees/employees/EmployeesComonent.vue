<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('label.employees') }}</h3>
            </div>
        </div>
...
export default {
    ...
    data() {
        ...
        return {
            table: {
                fields: [
                    { name: this.$t('label.number'), status: true },
                    { name: this.$t('label.name'), status: true },
                    { name: this.$t('label.branch'), status: true },
                    { name: this.$t('label.last_transaction_date'), status: true },
                    { name: this.$t('label.phone'), status: true },
