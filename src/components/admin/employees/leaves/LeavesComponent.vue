<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('label.leaves') }}</h3>
            </div>
        </div>
        ...
        return {
            table: {
                fields: [
                    ...
                    { name: this.$t('label.job_title'), status: true },
                    { name: this.$t('label.leave_type'), status: true },
                    { name: this.$t('label.start_date'), status: true },
                    { name: this.$t('label.end_date'), status: true },
                    { name: this.$t('label.leave_days'), status: true },
                    { name: this.$t('label.status'), status: true },
                    { name: this.$t('label.previous_balance'), status: false },
                    { name: this.$t('label.deducted'), status: false },
                    { name: this.$t('label.remaining_balance'), status: false },
                    { name: this.$t('label.notes'), status: false }
                ]
