<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('label.monthly_revenue_expense_report') }}</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                <div class="d-flex align-items-center actions mb-0">
                    <div class='search me-2 mb-3'>
                        ...
                        <span class="text-main">{{ $t('label.search_report') }}</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="d-flex align-items-center justify-content-end">
                    <div class="pages">
                        ...
                        <p class="text-main mb-0">{{ $t('label.income_expense_report') }}</p>
        ...
        return {
            table: {
                fields: [
                    ...
                    { name: this.$t('label.amount'), status: true },
                    { name: this.$t('label.sales_tax'), status: true },
                    { name: this.$t('label.profit_margin'), status: true },
                    { name: this.$t('label.accounting_entry'), status: true }
                ]
