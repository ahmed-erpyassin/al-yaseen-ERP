<template>
    <div class="container pe-5 ps-5">
        ...
        <form class="form">
            <div class="row">
                <div class="col-12">
                    <h3 class="mb-5">{{ $t('label.outgoing_shipment') }}</h3>
                </div>
                <div class="col-md-2">
                    <div class="item mb-4">
                        <div class="mb-3 position-relative">
                            <label for="notebook" class="form-label">{{ $t('label.notebook') }}</label>
                ...
                <div class="col-md-2">
                    <div class="item mb-4">
                        <div class="mb-3 position-relative">
                            <label for="invoice_no" class="form-label">{{ $t('label.invoice_no') }}</label>
            ...
            <div class="row mb-5">
                <div class="col-md-2">
                    <div class="item mb-4">
                        <div class="mb-3 position-relative">
                            <label for="customer_no" class="form-label">{{ $t('label.customer_no') }}</label>
            ...
            <h3 class="mb-5">{{ $t('label.shipment_information') }}</h3>
