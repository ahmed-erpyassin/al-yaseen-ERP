<template>
    <div class="container pe-5 ps-5">
        ...
        <form class="form">
            <h3 class="mb-5">{{ $t('label.invoices_with_wrong_tax_rate') }}</h3>
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <h5 class="mb-3">{{ $t('label.notebook_number') }}</h5>
                        <div class="col-md-6">
                            <div class="mb-3 position-relative">
                                <label for="from" class="form-label">{{ $t('label.from') }}</label>
                                <input type="text" id="fax_number" class="form-control rounded-1" />
                    ...
                    <div class="row mb-3">
                        <h5 class="mb-3">{{ $t('label.statement_number') }}</h5>
                        <div class="col-md-6">
                            <div class="mb-3 position-relative">
                                <label for="from" class="form-label">{{ $t('label.from') }}</label>
                                <input type="text" id="fax_number" class="form-control rounded-1" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <h5 class="mb-3">{{ $t('label.invoice_number') }}</h5>
                        <div class="col-md-6">
                            <div class="mb-3 position-relative">
                                <label for="from" class="form-label">{{ $t('label.from') }}</label>
                                <input type="text" id="fax_number" class="form-control rounded-1" />
