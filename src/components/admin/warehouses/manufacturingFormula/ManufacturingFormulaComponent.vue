...
=======
        ...
        <div class="d-flex align-items-center justify-content-end">
            <router-link :to="{ name: 'admin.warehouses.manufacturing-formula.create' }" class="btn btn-lg btn-main me-3">{{
                $t('buttons.create')
            }}</router-link>
            ...
            <div class="col-md-8">
                <div class="d-flex align-items-center actions mb-0">
                    <div class='search me-2 mb-3'>
                        <i class="bi bi-search me-2"></i>
                        <span class="text-main">{{ $t('label.search_manufacturing_equation') }}</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="d-flex align-items-center justify-content-end">
                    <div class="pages">
                        ...
                        <p class="text-main mb-0">{{ $t('label.manufacturing') }}</p>
                        <p class="text-main mb-0">{{ $t('label.manufacturing_equations_report') }}</p>
        ...
        return {
            table: {
                fields: [
                    ...
                    { name: this.$t('label.sale_price'), status: true },
                    { name: this.$t('label.purchase_price'), status: true },
                    { name: this.$t('label.color'), status: false },
                    { name: this.$t('label.length'), status: false },
                    { name: this.$t('label.width'), status: false },
                    { name: this.$t('label.height'), status: false },
                    { name: this.$t('label.date'), status: false },
                    { name: this.$t('label.time'), status: false }
                ]
