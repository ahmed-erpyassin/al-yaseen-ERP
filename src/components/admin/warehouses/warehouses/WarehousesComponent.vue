<template>
    <div class="container pe-5 ps-5">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-5">{{ $t('label.warehouses') }}</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                <div class="d-flex align-items-center actions mb-0">
                    <div class='search me-2 mb-3'>
                        ...
                        <span class="text-main">{{ $t('label.search_warehouse') }}</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="d-flex align-items-center justify-content-end">
                    <div class="pages">
                        ...
                        <p class="text-main mb-0">{{ $t('label.warehouse_balances') }}</p>
...
export default {
    ...
    data() {
        ...
        return {
            table: {
                fields: [
                    { name: this.$t('label.warehouse_number'), status: true },
                    { name: this.$t('label.warehouse_name'), status: true },
                    { name: this.$t('label.warehouse_keeper'), status: true },
                    { name: this.$t('label.phone_number'), status: true },
                    { name: this.$t('label.fax_number'), status: true },
                    { name: this.$t('label.address'), status: true }
                ]
