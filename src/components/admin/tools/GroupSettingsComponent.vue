        ...
        <form class="form">
            ...
            <div class="tabs">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="general_data" role="tabpanel" aria-labelledby="accounts-tab">
                    ...
                    <div class="tab-pane fade" id="accounts_and_journal_entries" role="tabpanel"
                        ...
                        <div class="tabs accounts">
                            <ul class="nav nav-pills justify-content-start rounded-2" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tax_accounts-tab" data-bs-toggle="tab"
                                        data-bs-target="#tax_accounts" type="button" role="tab" aria-controls="tax_accounts"
                                        aria-selected="false">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show" id="other_accounts" role="tabpanel"
                                    aria-labelledby="accounts-tab">
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mt-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.employee_salaries_account') }}</label>
                                        ...
                                        <div class="col-md-6 mb-3 mt-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.transport_wages_debit_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.transport_wages_credit_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.currency_difference_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.salary_allowances_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.overtime_allowance_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.transportation_allowance_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.social_insurance_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.employer_share_insurance_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="mb-3 position-relative">
                                                <label for="from" class="form-label">{{ $t('label.health_insurance_account') }}</label>
                                                <input type="text" id="from" class="form-control rounded-1" />
