            ...
            menuSections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: 'aside.risks', to: { name: 'admin.projects.risks' }, icon: 'bi bi-exclamation-triangle-fill' },
                        { label: 'aside.close projects', to: { name: 'admin.projects.close' }, icon: 'bi bi-lock-fill' },
                    ]
                },
                {
                    id: 'cheques',
