                ...
                <form @submit.prevent="submitForm" class="form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="item">
                                <div class="mb-3 position-relative">
                                    <label for="company_type" class="form-label">{{ $t('label.company_field') }}</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="item">
                                <div class="mb-3 position-relative">
                                    ...
                                    <Select v-model="form.currency_id" :options="currencies"
                                        :label-by="locale === 'ar' ? 'name_ar' : 'name_en'" value-by="id"
                                        placeholder="" />
                                </div>
